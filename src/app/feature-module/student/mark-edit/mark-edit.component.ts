...
export class MarkEditComponent implements OnInit {
  ...
  editMarkForm: FormGroup = new FormGroup({
    ...
    markPointNumber1: new FormControl('', [Validators.required,Validators.min(0),Validators.max(10),Validators.pattern("^[0-9]*$")]),
    markPointNumber2: new FormControl('',[Validators.required,Validators.min(0),Validators.max(10),Validators.pattern("^[0-9]*$")]),
    markPointNumber3: new FormControl('',[Validators.required,Validators.min(0),Validators.max(10),Validators.pattern("^[0-9]*$")]),
