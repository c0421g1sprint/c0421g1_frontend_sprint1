...
export class EditInforTeacherComponent implements OnInit {
  ...
  constructor(private teacherService: TeacherService, private divisionService: DivisionService, private snackBar: MatSnackBar, private activatedRoute: ActivatedRoute) {
